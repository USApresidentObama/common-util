...
//        serializerFactory.addSpecificMapping(String.class, new StringUnicodeSerializer());
    ...
    public static Object json2otherObject(String jsonStr, Class<?> clazz) {
        ...
        try {
            ...
            logger.warn("json=" + ignoreChars(jsonStr) + ", clazz=" + clazz + " , json2otherObject fail", e);
        }
        return clazzObj;
    }
    ...
    public static Object json2object(String jsonStr, Class<?> clazz) {
        ...
        try {
            ...
            logger.warn("json=" + ignoreChars(jsonStr) + ", clazz=" + clazz + " , json2object fail", e);
        }
    ...
    public static Map<String, Object> json2map(String jsonStr) {
        ...
        try {
            ...
            logger.warn("json=" + ignoreChars(jsonStr) + " , json2map fail", e);
        }
        return map;
    }
    ...
    public static Map<String, Object> json2map(String jsonStr, String fieldname, Class<?> clazz) {
        ...
        try {
            ...
            logger.warn("json=" + ignoreChars(jsonStr) + ", fieldname=" + fieldname + ", clazz=" + clazz
                    + " , json2map fail", e);
        }
        return map;
    }
    ...
    public static Object toObject(String json, Class<?> objclass) {
        ...
        try {
            ...
            logger.warn("json=" + ignoreChars(json) + ", objclass=" + objclass + " , toObject fail", e);
        }
    ...
    public static Map<String, String> getRootJson(String json) {
        ...
        try {
            ...
            logger.warn("json=" + ignoreChars(json) + " , getRootJson fail", e);
        }
        if (rootNode == null) {
            return null;
        }
    ...
    public static String getJsonData(String json, String fieldname) {
        ...
        try {
            ...
            logger.warn("json=" + ignoreChars(json) + ", fieldname=" + fieldname + " , getJsonData fail", e);
        }
        if (rootNode == null) {
            return null;
        }
    ...
    public static String getRawJsonData(String json, String fieldname) {
        ...
        try {
            ...
            logger.warn("json=" + ignoreChars(json) + ", fieldname=" + fieldname + " , getRawJsonData fail", e);
        }
        if (rootNode == null) {
            return null;
        }
